...
class LSTMModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        # TODO(shengwang): Add more hyper parameters to control the prednet.
        # fmt: on
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens):
        ...
        if self.prop_predict:
            ...
            _, hidden_out = encoder_out['encoder_out'][:2]
            fp = hidden_out
            # Size(num_layers * num_directions), batch size and hidden size.
