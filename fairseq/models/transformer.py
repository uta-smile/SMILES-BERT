...
from . import (FairseqEncoder, FairseqIncrementalDecoder, FairseqLanguageModel,
               FairseqModel, PredNet, register_model,
...
class TransformerModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            metavar='STR',
            help='How the fingerprint is extracted from Encoder.')
        # fmt: on
    ...
    def build_model(cls, args, task):
        ...
        decoder = TransformerDecoder(
            args, tgt_dict, decoder_embed_tokens, left_pad=args.left_pad_source)
        ...
        return TransformerModel(encoder, decoder, args.prop_predict, prednet,
                                args.get_fp, args.fp_type)
    ...
    def build_model(cls, args, task):
        ...
        if args.character_embeddings:
            ...
            embed_tokens = Embedding(
                len(task.dictionary), args.decoder_input_dim,
                task.dictionary.pad())
