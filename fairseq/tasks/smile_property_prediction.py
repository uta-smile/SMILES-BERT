...
from fairseq.data import (ConcatDataset, Dictionary, GeneralSmileDictionary,
                          IndexedCachedDataset, IndexedDataset,
                          IndexedRawTextDataset, IndexedSmilePropertyDataset,
                          LanguagePairDataset, SmileDictionary,
                          SmilePredictionDataset, data_utils)

from . import FairseqTask, register_task


@register_task('smile_property_prediction')
class SmilePropertyPredictionTask(FairseqTask):
    """
    Predict molecular property/properties from the SMILEs of molecule.
    
    TODO(shengwang): Remove irrelated parts and rework the description.
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            '--get-fp', action='store_true', help='if to get finger print')
        ...
        parser.add_argument(
            ...
            type=str,
            metavar='BOOL',
            help='If using the previous tokens as the decoder input feed.')
    ...
    def setup_task(cls, args, **kwargs):
        ...
        args.input_feed = options.eval_bool(args.input_feed)
