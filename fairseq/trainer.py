...
from fairseq.logger import Logger
...
class Trainer(object):
    ...
    def __init__(self,
        ...
        # Support TensorBoard SummaryWriter.
    ...
    def init_meters(self, args):
        ...
        self.meters[
            'train_wall'] = StopwatchMeter()  # train wall time in seconds
    ...
    def train_step(self, samples, dummy_batch=False):
        ...
        try:
            ...
            self.meters['clip'].update(1. if grad_norm > self.args.clip_norm and
                                       self.args.clip_norm > 0 else 0.)
    ...
    def set_summary_writer(self, log_dir=None):
        self.summary_writer = Logger(log_dir)
