...
def parse_args_and_arch(parser, input_args=None, parse_known=False):
    ...
    if hasattr(args, 'prop_weight'):
        args.prop_weight = eval_str_list(args.prop_weight, type=float)
    if hasattr(args, 'cls_index'):
        args.cls_index = eval_str_list(args.cls_index, type=int)
